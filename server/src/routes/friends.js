...
import FriendshipController from '../controllers/user/FriendshipController.js';
...
router.get('/friendship/status/:id', authenticateJWT, requireRole('user'), FriendshipController.getFriendshipStatus);
