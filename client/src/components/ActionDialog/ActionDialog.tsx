...
import { ActionDialogProps, DialogType } from './types';

const cx = classNames.bind(styles);

// 2. Map Icon với kiểu dữ liệu React.ReactElement
const ICON_MAP: Record<DialogType, React.ReactElement> = {
...
const TYPE_CLASS_MAP: Record<DialogType, string> = {
    default: 'btn-primary',
    confirm: 'btn-success',
    delete: 'btn-danger',
    report: 'btn-danger',
